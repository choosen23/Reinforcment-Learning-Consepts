...
STEPS_NUM = 200 #number of steps
# start_q_table = "qtable-1657630030.pickle"  # if we have a pickled Q table, we'll put the filename of it here.
start_q_table = None
...
#start itterating over episodes
